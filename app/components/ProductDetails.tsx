...
const ProductDetails = ({data}: ProductCardProps) => {
  ...
  return (
    <div className="wrapper px-4 lg:px-0">
      <BreadCrums routes={["Home", "Collections", data.name]} />
      <div className=" flex flex-col lg:flex-row justify-between gap-6 mb-12 md:mb-20">
        ...
        <div className="lg:w-1/2 w-full flex flex-col gap-4">
          ...
          <div className="flex gap-5">
            <ButtonGroup radius="full" className="font-satoshiBold">
              ...
              <Button
                disabled
                className="text-xl font-satoshi h-full"
                size="sm"
              >
                {quantity}
              </Button>
